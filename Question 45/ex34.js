...
var pizza = ['Arabic Raanch', 'Tikka Fajita', 'Pepperoni pizza'];
...
var pizzaTypes = ["Pepperoni", "Arabic Ranch", "Tikka Fajita"];
for (var i = 0; i < pizzaTypes.length; i++) {
    var pizza_1 = pizzaTypes[i];
    console.log("I enjoy the ".concat(pizza_1, " pizza for its unique flavors and delicious ingredients."));
